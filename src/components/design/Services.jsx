  ...
  return (
    <div className="absolute top-8 right-8 w-[18rem] h-[6rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-16 lg:right-[8.75rem]">
      <Typewriter
        options={{
          strings: [
            "Generate your roadmap for ML Engineer.",
            "Start a mock interview for data science.",
            "Show-Case your next roadmap milestone.",
            "Create a custom interview set for Frontend Developer.",
            "Connect yourself to the #hashtag community.",
            "Show the community your Skills",
...
export const VideoChatMessage = ({ isPlaying }) => {
  return (
    <div className="absolute top-8 left-[3.125rem] w-full max-w-[14rem] pt-2.5 pr-2.5 pb-7 pl-5 bg-n-6 rounded-t-xl rounded-br-xl font-code text-base md:max-w-[17.5rem]">
      <Typewriter
        options={{
          strings: isPlaying ? ["Interview generating..."] : ["Interview generated!"],
          cursor: isPlaying ? "|" : "",
          autoStart: true,
